...
-- Run this after basic schema is working well
...
-- Date-only indexes for daily reporting
CREATE INDEX IF NOT EXISTS idx_deposits_date 
ON deposits(DATE(to_timestamp(created_at / 1000)));

CREATE INDEX IF NOT EXISTS idx_withdrawals_date 
ON withdrawals(DATE(to_timestamp(created_at / 1000)));

CREATE INDEX IF NOT EXISTS idx_transactions_date 
ON transactions(DATE(to_timestamp(created_at / 1000)));
...
-- 
-- TOTAL ADDITIONAL INDEXES: 32
-- 
-- NEXT STEP: Monitor query performance with pg_stat_statements
-- ============================================
