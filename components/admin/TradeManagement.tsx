      ...
      try {
        ...
        if (Array.isArray(openPositions)) {
          ...
          setDbOpenTrades(openTradesFiltered.map((pos: any) => ({
              ...
              entryPrice: parseFloat(pos.entry_price || pos.price || 0),
              currentPrice: parseFloat(pos.current_price || pos.entry_price || pos.price || 0),
              quantity: parseFloat(pos.amount || pos.units || pos.volume || 0),
              leverage: pos.leverage || 1,
              margin: (parseFloat(pos.amount || pos.units || pos.volume || 0) * parseFloat(pos.entry_price || pos.price || 0)) / (pos.leverage || 1),
