...
import imgHeroBg from 'figma:asset/e4e622beace9f9ac7d6d8e07b886d945dad43569.png';
...
const subNavItems = [
  ...
  { label: 'Cryptocurrency CFDs', path: '/crypto-cfds', active: true },
      ...
      <section className="relative flex items-center justify-center" style={{ minHeight: 478 }}>
        ...
        <div className="relative z-10 text-center px-4 pt-28 pb-20 max-w-3xl mx-auto">
          ...
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
            Cryptocurrencies are volatile, unregulated, decentralised and controlled almost
            exclusively by retail speculators. Trade the world's newest and most exciting asset
            class as CFDs with an FSA regulated Forex CFD Provider.
          </p>
          <Link
            to="/login"
