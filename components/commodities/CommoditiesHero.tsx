...
const subNavItems = [
  ...
  { label: 'Commodities CFDs',    path: '/commodities-cfd', active: true },
      ...
      <section className="relative flex items-center justify-center" style={{ minHeight: 478 }}>
        ...
        <div className="relative z-10 text-center px-4 pt-28 pb-20 max-w-3xl mx-auto">
          ...
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
            Trade the most popular CFDs on Commodities from around the world, including energies,
            agriculture and metals. xAI Technology combines tight pricing and flexible conditions
            to give you one powerful product.
          </p>
          <Link
            to="/login"
