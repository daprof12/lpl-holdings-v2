...
const subNavItems = [
  ...
  { label: 'Futures CFDs',        path: '/futures-cfd', active: true },
];
  ...
  return (
    <>
      ...
      <section className="relative flex items-center justify-center" style={{ minHeight: 478 }}>
        ...
        <div className="relative z-10 text-center px-4 pt-28 pb-20 max-w-4xl mx-auto">
          ...
          <p className="text-white/80 text-base md:text-lg max-w-3xl mx-auto mb-8 leading-relaxed">
            Futures are one of the most popular form of CFDs. xAI Technology offer a range of
            Futures from around the world, including ICE Dollar Index and CBOE VIX Index.
            Online Futures based CFDs are offered exclusively on XAI Technology's MetaTrader
            4 &amp; 5 Platform.
          </p>
          <Link
            to="/login"
