import svgPaths from "./svg-usnf9rve84";
...
export default function Background() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center px-[28.695px] py-[106.24px] relative size-full" data-name="Background" style={{ backgroundImage: "linear-gradient(20deg, rgb(99, 142, 223) 25%, rgb(234, 238, 255) 60%)" }}>
      <Container />
    </div>
  );
}